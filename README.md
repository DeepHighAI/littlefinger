...
W01 초대 랜딩 · W02 약속 검토 · W03 승인 완료 · W04 참여 약속 열람·응답(+마무리 요청 응답) ·
W05 증인 확인(+종료일 없음) · W06 링크 무효·만료

**안드로이드 앱 (SCR-A)**
A00 온보딩 · A01 로그인 · A02 홈(+빈 상태, +6건 이상 인피드 배너) · A03 약속 작성 · A04 초대 전송·대기 ·
A05 약속 상세 **9개 상태 변형**(+ACTIVE 종료일 없음, +AMEND_PENDING 마무리 협의) · A06 이행 확인 입력 ·
A07 알림함 · A08 마이·약속 지킴율 · A09 지난 약속 히스토리

**모달 (MOD)**
MOD-01 변경·파기 요청(+종료일 없음 선택지) · MOD-02 증인 초대 · MOD-03 완료 축하 · MOD-04 슬롯 결제 ·
MOD-05 혜택 시트(+광고 잠김)
