...
describe('SCR-A07 알림함', () => {
  ...
  test.each([
    ...
    ['NT-02', { semanticType: 'APPROVAL', icon: 'cancel', tone: 'muted', label: '승인 응답' }],
    ...
    ['NT-08', { semanticType: 'FULFILLMENT', icon: 'notification_important', tone: 'pink', label: '이행 확인' }],
    ['NT-09', { semanticType: 'FULFILLMENT', icon: 'notification_important', tone: 'pink', label: '이행 확인' }],
    ['NT-10', { semanticType: 'FULFILLMENT', icon: 'notification_important', tone: 'pink', label: '이행 확인' }],
    ['NT-11', { semanticType: 'RESULT', icon: 'inventory_2', tone: 'paper', label: '이행 결과' }],
    ['NT-12', { semanticType: 'RESULT', icon: 'inventory_2', tone: 'paper', label: '이행 결과' }],
    ['NT-13', { semanticType: 'RESULT', icon: 'inventory_2', tone: 'paper', label: '이행 결과' }],
    ['NT-14', { semanticType: 'RESULT', icon: 'inventory_2', tone: 'paper', label: '이행 결과' }],
    ...
    ['NT-19', { semanticType: 'FULFILLMENT', icon: 'notification_important', tone: 'pink', label: '이행 확인' }],
