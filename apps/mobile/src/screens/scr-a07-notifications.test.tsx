...
describe('SCR-A07 알림함', () => {
  ...
  test.each([
    ...
    ['NT-02', { semanticType: 'APPROVAL', icon: 'cancel', tone: 'default', label: '승인 응답' }],
    ['NT-03', { semanticType: 'AMEND', icon: 'sync_alt', tone: 'default', label: '변경 요청' }],
    ...
    ['NT-08', { semanticType: 'FULFILLMENT', icon: 'notification_important', tone: 'urgent', label: '이행 확인' }],
    ['NT-09', { semanticType: 'FULFILLMENT', icon: 'notification_important', tone: 'urgent', label: '이행 확인' }],
    ['NT-10', { semanticType: 'FULFILLMENT', icon: 'notification_important', tone: 'urgent', label: '이행 확인' }],
    ['NT-11', { semanticType: 'RESULT', icon: 'inventory_2', tone: 'default', label: '이행 결과' }],
    ['NT-12', { semanticType: 'RESULT', icon: 'inventory_2', tone: 'default', label: '이행 결과' }],
    ['NT-13', { semanticType: 'RESULT', icon: 'inventory_2', tone: 'default', label: '이행 결과' }],
    ['NT-14', { semanticType: 'RESULT', icon: 'inventory_2', tone: 'default', label: '이행 결과' }],
    ['NT-15', { semanticType: 'AMEND', icon: 'sync_alt', tone: 'default', label: '변경 요청' }],
    ['NT-16', { semanticType: 'AMEND', icon: 'sync_alt', tone: 'default', label: '변경 요청' }],
    ['NT-17', { semanticType: 'AMEND', icon: 'sync_alt', tone: 'default', label: '변경 요청' }],
    ['NT-18', { semanticType: 'CONFIRMATION', icon: 'pinky', tone: 'accent', label: '약속 확정' }],
    ['NT-19', { semanticType: 'FULFILLMENT', icon: 'notification_important', tone: 'urgent', label: '이행 확인' }],
    ['NT-20', { semanticType: 'AMEND', icon: 'sync_alt', tone: 'default', label: '변경 요청' }],
