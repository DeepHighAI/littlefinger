...
describe('SCR-A07 알림함', () => {
  ...
  test.each([
    ['NT-01', { semanticType: 'CONFIRMATION', icon: 'eyes', tone: 'paper', label: '약속 확정' }],
    ['NT-02', { semanticType: 'APPROVAL', icon: 'cancel', tone: 'muted', label: '수락 응답' }],
    ['NT-03', { semanticType: 'AMEND', icon: 'sync_alt', tone: 'sky', label: '변경 요청' }],
    ['NT-04', { semanticType: 'REMINDER', icon: 'alarm', tone: 'cream', label: '리마인드' }],
    ['NT-05', { semanticType: 'REMINDER', icon: 'alarm', tone: 'cream', label: '리마인드' }],
    ['NT-06', { semanticType: 'REMINDER', icon: 'alarm', tone: 'cream', label: '리마인드' }],
    ['NT-07', { semanticType: 'REMINDER', icon: 'alarm', tone: 'cream', label: '리마인드' }],
    ['NT-08', { semanticType: 'FULFILLMENT', icon: 'notification_important', tone: 'pink', label: '지킴 확인' }],
    ['NT-09', { semanticType: 'FULFILLMENT', icon: 'notification_important', tone: 'pink', label: '지킴 확인' }],
    ['NT-10', { semanticType: 'FULFILLMENT', icon: 'notification_important', tone: 'pink', label: '지킴 확인' }],
    ['NT-11', { semanticType: 'RESULT', icon: 'inventory_2', tone: 'paper', label: '지킴 결과' }],
    ['NT-12', { semanticType: 'RESULT', icon: 'inventory_2', tone: 'paper', label: '지킴 결과' }],
    ['NT-13', { semanticType: 'RESULT', icon: 'inventory_2', tone: 'paper', label: '지킴 결과' }],
    ['NT-14', { semanticType: 'RESULT', icon: 'inventory_2', tone: 'paper', label: '지킴 결과' }],
    ['NT-15', { semanticType: 'AMEND', icon: 'sync_alt', tone: 'sky', label: '변경 요청' }],
    ['NT-16', { semanticType: 'AMEND', icon: 'sync_alt', tone: 'sky', label: '변경 요청' }],
    ['NT-17', { semanticType: 'AMEND', icon: 'sync_alt', tone: 'sky', label: '변경 요청' }],
    ['NT-18', { semanticType: 'CONFIRMATION', icon: 'eyes', tone: 'paper', label: '약속 확정' }],
    ['NT-19', { semanticType: 'FULFILLMENT', icon: 'notification_important', tone: 'pink', label: '지킴 확인' }],
    ['NT-20', { semanticType: 'AMEND', icon: 'sync_alt', tone: 'sky', label: '변경 요청' }],
    ['NT-21', { semanticType: 'REMINDER', icon: 'alarm', tone: 'cream', label: '리마인드' }],
  ] as const)('%s는 수락된 의미 유형과 아이콘을 사용한다', (event, expected) => {
