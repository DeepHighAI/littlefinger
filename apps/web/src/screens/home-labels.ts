...
const ko = {
  ...
  purpose: [
    ...
    '약속을 만드는 사람은 Android 앱을 쓰고, 상대는 받은 초대 링크에서 앱 설치 없이 내용을 확인하고 수락해요.',
  ],
  howTitle: '이렇게 사용해요',
  how: [
    '약속 작성 — 약속 내용, 지킬 사람, 종료일, 보상과 벌칙까지 적어 두면 나중에 말이 엇갈리지 않아요.',
    '초대 링크 공유 — 링크 하나면 끝. 상대는 앱을 설치하지 않아도, 아이폰에서도 웹으로 열어 수락할 수 있어요.',
    '함께 확정 — 두 사람이 모두 수락해야 약속이 시작돼요. 확정된 약속 기록은 그대로 보관됩니다.',
    '리마인드 — D-7 / D-3 / D-1 / 당일에 알려드려요.',
    '지킴 확인 — 종료일이 되면 두 사람에게 "약속 지켜졌나요?" 하고 물어봐요.',
