...
| NT-15 | 변경·파기 요청 도착 | 상대 당사자 | PUSH+INAPP(앱) / INAPP(웹) | 즉시 | "{상대}님이 약속 {변경/파기}을 요청했어요" | SCR-A05 / SCR-W04 |
| NT-16 | 변경·파기 응답(승인/거절) | 요청자 | PUSH+INAPP(앱) / INAPP(웹) | 즉시 | "요청이 {승인/거절}됐어요" | SCR-A05 |
...
- **조용한 시간(21:00~08:00 KST)**: NT-04, NT-06~NT-08, NT-10, NT-20, NT-21(스케줄 알림)은 다음 08:00으로 이연. NT-01~NT-03, NT-09, NT-11~NT-19(즉시성 알림)는 예외로 즉시 발송한다.
...
- [ ] 배치 J-01~J-06·J-08~J-10을 동일 시각으로 연속 2회 실행해도 결과가 동일하다(멱등). **J-07은 PO 결정으로 현재 범위 제외**.
